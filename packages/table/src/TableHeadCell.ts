...
import arrowStyles from '@spectrum-web-components/icon/src/spectrum-icon-arrow.min.css' assert { type: 'css' };
import stylesDefault from './spectrum-table-head-cell.min.css' assert { type: 'css' };
import stylesOveride from './table-head-cell.min.css' assert { type: 'css' };
