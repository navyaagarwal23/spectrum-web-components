...
import checkmarkSmallStyles from '@spectrum-web-components/icon/src/spectrum-icon-checkmark.min.css' assert { type: 'css' };
import dashSmallStyles from '@spectrum-web-components/icon/src/spectrum-icon-dash.min.css' assert { type: 'css' };
import stylesDefault from './spectrum-checkbox.min.css' assert { type: 'css' };
import stylesOveride from './checkbox.min.css' assert { type: 'css' };
