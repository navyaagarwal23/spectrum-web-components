...
import stylesWrapperDefault from '@spectrum-web-components/modal/src/spectrum-modal-wrapper.min.css' assert { type: 'css' };
import stylesWrapperOveride from '@spectrum-web-components/modal/src/modal-wrapper.min.css' assert { type: 'css' };
import stylesModalDefault from '@spectrum-web-components/modal/src/spectrum-modal.min.css' assert { type: 'css' };
import stylesModalOveride from '@spectrum-web-components/modal/src/modal.min.css' assert { type: 'css' };
