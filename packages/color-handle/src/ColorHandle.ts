...
import opacityCheckerboardStyles from '@spectrum-web-components/opacity-checkerboard/src/is-opacity-checkerboard.min.css' assert { type: 'css' };
import stylesDefault from './spectrum-color-handle.min.css' assert { type: 'css' };
import stylesOveride from './color-handle.min.css' assert { type: 'css' };
