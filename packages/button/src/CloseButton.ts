...
import stylesDefault from '@spectrum-web-components/close-button/src/spectrum-close-button.min.css' assert { type: 'css' };
import stylesOveride from '@spectrum-web-components/close-button/src/close-button.min.css' assert { type: 'css' };
