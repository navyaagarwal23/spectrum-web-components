...
import crossMediumStyles from '@spectrum-web-components/icon/src/spectrum-icon-cross.min.css' assert { type: 'css' };
import stylesDefault from '@spectrum-web-components/clear-button/src/spectrum-clear-button.min.css' assert { type: 'css' };
import stylesOveride from '@spectrum-web-components/clear-button/src/clear-button.min.css' assert { type: 'css' };
