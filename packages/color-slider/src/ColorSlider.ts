...
import opacityCheckerBoardStyles from '@spectrum-web-components/opacity-checkerboard/src/opacity-checkerboard.min.css' assert { type: 'css' };
import stylesDefault from './spectrum-color-slider.min.css' assert { type: 'css' };
import stylesOveride from './color-slider.min.css' assert { type: 'css' };
