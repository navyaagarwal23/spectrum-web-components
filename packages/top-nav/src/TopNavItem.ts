...
import stylesDefault from '@spectrum-web-components/tabs/src/spectrum-tab.min.css' assert { type: 'css' };
import stylesOveride from '@spectrum-web-components/tabs/src/tab.min.css' assert { type: 'css' };
