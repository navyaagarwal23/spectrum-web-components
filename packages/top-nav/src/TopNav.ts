...
import stylesSizes from '@spectrum-web-components/tabs/src/tabs-sizes.min.css' assert { type: 'css' };
import stylesDefault from '@spectrum-web-components/tabs/src/spectrum-tabs.min.css' assert { type: 'css' };
import stylesOveride from '@spectrum-web-components/tabs/src/tabs.min.css' assert { type: 'css' };
import stylesLocal from './top-nav-item.min.css' assert { type: 'css' };
