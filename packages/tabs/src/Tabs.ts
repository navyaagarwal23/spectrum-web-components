...
import stylesSizes from './tabs-sizes.min.css' assert { type: 'css' };
import stylesDefault from './spectrum-tabs.min.css' assert { type: 'css' };
import stylesOveride from './tabs.min.css' assert { type: 'css' };
